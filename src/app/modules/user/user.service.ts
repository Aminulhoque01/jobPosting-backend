...
const updateMyProfile = async (
  ...
  // Update and return user with all fields
  return User.findByIdAndUpdate(id, payload, { new: true, runValidators: true }).select(
    "_id fullName email role isDeleted isBlocked isEmailVerified isResetPassword oneTimeCode oneTimeCodeExpire otpCountDown status appliedJobs savedJobs createdAt updatedAt __v profileImage"
  );
};
